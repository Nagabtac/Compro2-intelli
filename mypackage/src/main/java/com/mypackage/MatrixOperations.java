...
public class MatrixOperations {
    public static void main(String[] args) {
        ...
        System.out.print("Enter row to get data: ");
        int getRow = scanner.nextInt();
        System.out.print("Enter column to get data: ");
        int getColumn = scanner.nextInt();

        try {
            int value = matrix.getValueAt(getRow, getColumn);
            System.out.println("Value at (" + getRow + ", " + getColumn + ") is: " + value);
